...
Make a tech spec document of everything that was used to create this project, including all the technologies, Cloudflare dependencies, and what the front-end was made with etc.
